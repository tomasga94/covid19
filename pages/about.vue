<template>
  <div class="About">
    ...
    <TextCard>
      {{
        $t(
          '当サイトは新型コロナウイルス感染症 (COVID-19) に関する最新情報を提供するために、コスタリカ人の社会人が開発・開設したものです。
      ...
      {{
        $t(
          'コスタリカによる公式情報と客観的な数値をわかりやすく伝えることで、東京都にお住まいの方や、東京都内に拠点を持つ企業の方、東京都を訪れる方が、現状を把握して適切な対策を取れるようにすることを目的としています。'
        )
      }}
    </TextCard>
    ...
    <TextCard :title="$t('免責事項')">
      {{
        $t(
          '当サイトに掲載されている情報の正確性については万全を期していますが、当サイトの開発者・関係者は、利用者が当サイトの情報を用いて行う一切の行為について責任を負うものではありません。'
        )
      }}<br />
      <br />
      {{
    ...
    <TextCard :title="$t('ソースコードについて')">
      ...
      <i18n path="詳しくは、{githubRepo}をご確認ください。">
        <a
          href="https://github.com/tomasga94/covid19"
          target="_blank"
          rel="noopener"
          place="githubRepo"
        >
